const intersectionBetween = (draggableClientRect, itemClientRect) => {
  const draggable_ = {
...
export const getBestIntersection = ({
  draggable,
  items,
  ...
  items.forEach((item, indexItem) => {
    ...
    const percent = intersectionBetween(draggableClientRect, itemClientRect);
